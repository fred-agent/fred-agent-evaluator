...
revision: str = "527dc30e79d2"  # pragma: allowlist secret
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("evaluation_campaign", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_evaluation_campaign_task_id"), ["task_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_evaluation_campaign_team_id"), ["team_id"], unique=False
        )
    ...
    with op.batch_alter_table("evaluation_case", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_evaluation_case_campaign_id"), ["campaign_id"], unique=False
        )
    ...
    with op.batch_alter_table("evaluation_metric_result", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_evaluation_metric_result_campaign_id"),
            ["campaign_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_evaluation_metric_result_case_id"), ["case_id"], unique=False
        )
